...
class Profile(models.Model):
    ...
    unfinished_tasks = models.IntegerField(default=0)
    ...
    skills = models.CharField(max_length=100, default="DEFAULT")
...
class Project(models.Model):
	...
	alltasks = models.IntegerField(default=0)
	finished_tasks = models.IntegerField(default=0)
...
class File(models.Model):
	...
	description = models.TextField(default="DEFAULT")
	new_suggestion = models.BooleanField(default=False)	
	deployer = models.ForeignKey(User, db_constraint=False, on_delete=models.CASCADE, default=0)
	def __str__(self):
...
class Task(models.Model):
	...
	payment_calculated = models.BooleanField(default=False)
	progress = models.IntegerField(default=0)
	to_dos = models.IntegerField(default=0)
	finished_todos = models.IntegerField(default=0)
	budget = models.IntegerField(default=0)
	new_task = models.BooleanField(default=False)
	subject = models.CharField(max_length=100, default="DEFAULT")
...
class Application(models.Model):
	task = models.ForeignKey(Task, on_delete=models.CASCADE, default=0)
	profile = models.ForeignKey(Profile,db_constraint=False, on_delete=models.CASCADE, default=0)
	description = models.TextField()
	new_app = models.BooleanField(default=False)